/*
	SUBJECT :
	• Create a function that returns 1 if the string given as a parameter contains only uppercase alphabetical characters,
...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/30 23:01:44 by root              #+#    #+#             */
/*   Updated: 2024/10/06 19:04:57 by root             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
-> int ft_str_is_uppercase(char *str)
+ Purpose :
This line defines a function named ft_str_is_uppercase.

+ Details :
> int: The function returns an integer.
> ft_str_is_uppercase: The name of the function.
...
-> if ((str[i] < 65) || (str[i] > 90))
+ Purpose :
This line checks if the character at position i in the string (str) is not an uppercase alphabetical character.

+ Details :
> if: The conditional construct.
> (str[i] < 65): Checks if the character is less than 'A' (ASCII value 65).
> (str[i] > 90): Checks if the character is greater than 'Z' (ASCII value 90).
> ||: Logical OR operator.

--------------------------------------
-> return (0);
+ Purpose :
This line returns 0 if the character at position i in the string (str) is not an uppercase alphabetical character.
...
-> return (1);
+ Purpose :
This line returns 1 if all characters in the string (str) are uppercase alphabetical characters or if the string is empty.
...
-> printf("%d",ft_str_is_uppercase("SALAMCAVASALUT"));
+ Purpose :
This line prints the result of the ft_str_is_uppercase function when called with the string "SALAMCAVASALUT".

+ Details :
> printf: The function used to print formatted output.
> "%d": The format string for an integer.
> ft_str_is_uppercase("SALAMCAVASALUT"): The function call with the string "SALAMCAVASALUT" as the argument.

//____________________________________________________________________________________________________________________________________

 ## There are several ways to manipulate the 'ft_str_is_uppercase' function. ##
*/
